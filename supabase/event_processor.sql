...
BEGIN
  ...
  LOOP
    ...
    INSERT INTO news_items (headline, impacts, published, published_at, impacts_already_applied)
    VALUES (ev.news_headline, ev.impacts, false, now() + (v_news_slot * interval '10 minutes'), true);
  END LOOP;
END;
$$;
